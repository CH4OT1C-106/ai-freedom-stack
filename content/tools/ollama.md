...
- API-compatible — drop it into existing tools

## What's not

- Quality depends on your hardware — small machines = smaller models
- Not as powerful as frontier cloud models (GPT-5, Claude Opus)
- No built-in UI — you need a separate chat interface or use the terminal
